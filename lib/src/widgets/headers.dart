...
class _HeaderWavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.30, size.height * 0.35, size.width * 0.5, size.height * 0.30);
      ...
      children: <Widget>[
        ...
        Column(
          children: <Widget>[
            ...
            Text(
              titulo,
              style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: colorBlanco),
            ),
            const SizedBox(height: 20),
            FaIcon(
              icon,
